export default {
    ...
    'user-layout.menu.qrcode': '扫码登录',

    // user
    'page.user.login.form.username.title': '账号',
    'page.user.login.form.password.title': '密码',
    'page.user.login.form.forgotpassword': '忘记密码',
    'page.user.login.form.otherlogin': '其它方式登录',
    'page.user.login.form.loginloading': '登录中...',
    'page.user.login.form.loginfailed': '账号不存在，请检查账号',
